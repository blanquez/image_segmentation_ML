...
\begin{document}
 \setlength{\parskip}{1em} 
  ...
  \newpage
	...
	\par 
	Para evitar mezclar la información del conjunto de prueba con la del de entrenamiento aplicaremos ajustaremos esta transformación primero en el conjunto de entrenamiento y utilizaremos los rangos obtenidos en este para transformar el conjunto de prueba, ya que si no no podríamos confiar en el valor de $E_{test}$ para estimar $E_{out}$.
	...
	\par
	Además de los valores numéricos de error, vamos a estudiar ahora las matrices de confusión (izquierda $E_{in}$, derecha ${E_{test}}$) que nos permitirán saber cuales son las clases más problemáticas para nuestros modelos y sacar información más detallada acerca de la precisión del ajuste:
